...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        // tuy chinh kich thuoc chu [font-size, line-height]
        'title-xxl': ['44px', '55px'],
      ...
      spacing: {
        // tuy chinh khoang cach cac doi tuong nhu padding, margin, width, height
        4.5: '1.125rem',
        5.5: '1.375rem',
        6.5: '1.625rem',
        7.5: '1.875rem',
      ...
      content: {
        'icon-copy': 'url("/assets/images/icon-copy-alt.svg")',
      },
      transitionProperty: { width: 'width', stroke: 'stroke' },
      borderWidth: {
        // tuy chinh do day cua vien
        6: '6px',
        10: '10px',
        12: '12px',
      },
      ...
      keyframes: {
        // dinh nghia cac animation keyframes
        linspin: {
      ...
      animation: {
        // ket hop keyframes voi thoi gian va kieu chuyen dong
