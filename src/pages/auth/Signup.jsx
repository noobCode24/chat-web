      ...
      <div className='flex flex-wrap items-center h-full'>
        <div className='hidden w-full xl:block xl:w-1/2'>
          <div className='py-12.5 px-26 text-center'>
            ...
            <span className='mt-15 inline-block'>
              <img src={SignupIllustration} alt='login' className='w-64 h-auto object-cover' />
            </span>
          </div>
        </div>
        ...
        <div className='w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2 xl:px-44'>
          <div className='w-full p-4 sm:p-12.5 xl:p-5'>
            ...
            <h2 className='mb-4 text-2xl font-bold text-black dark:text-white sm:text-title-xl2'>Sign Up to Messenger</h2>
