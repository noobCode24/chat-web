          ...
          <div className='mx-auto w-full max-w-[480px]'>
            <div className='text-center'>
              ...
              <div className='bg-white p-4 shadow-14 rounded-xl dark:bg-boxdark lg:p-7.5 xl:p-12.5'>
                <h1 className='mg-2.5 text-3xl font-black leading-[48px] text-black dark:text-white'>
                  Verify your account
                </h1>

                <p className='mb-7.5 font-medium'>
                  Enter the 4 digit code sen to the registered email id
                </p>
                ...
                <form action=''>
                  ...
                  <p className='mb-5 mt-4 text-left font-medium dark:text-white space-x-2 flex flex-row items-center'>
