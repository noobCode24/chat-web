      ...
      <div className='flex flex-wrap items-center h-full'>
        <div className='hidden w-full xl:block xl:w-1/2'>
          <div className='py-12.5 px-26 text-center'>
            ...
            <p className='2xl:px-20'>
              Hey there 🫁, Welcome back. Login to chat with your friends & collections
            </p>

            <span className='mt-2 mr-19 inline-block'>
              <img src={LoginIllustration} alt='login' className='h-115 w-auto object-cover' />
            </span>
          </div>
        </div>
        ...
        <div className='w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2 xl:px-44'>
          <div className='w-full p-4 sm:p-12.5 xl:p-10'>
            ...
            <h2 className='mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2'>Sign In to Messenger</h2>
            ...
            <form action=''>
              ...
              <div className='mb-5' >
                <input onClick={() => { navigate('/dashboard') }} type='submit' value='Sign In' className='w-full cursor-pointer border border-primary bg-primary p-4 rounded-lg text-white transition hover:bg-opacity-90' />
              </div>
